...
export default defineComponent({
    data() {
        return {
            classAndPath: {
                totalClients: {
                    twClass: "p-3 mr-4 text-orange-500 bg-orange-100 rounded-full dark:text-orange-100 dark:bg-orange-500",
                ...
                accountBalance: {
                    twClass: "p-3 mr-4 text-green-500 bg-green-100 rounded-full dark:text-green-100 dark:bg-green-500",
                ...
                newSales: {
                    twClass: "p-3 mr-4 text-blue-500 bg-blue-100 rounded-full dark:text-blue-100 dark:bg-blue-500",
                ...
                pendingContacts: {
                    twClass: "p-3 mr-4 text-teal-500 bg-teal-100 rounded-full dark:text-teal-100 dark:bg-teal-500",
    ...
    computed: {
        getTwClass() {
            return this.classAndPath[this.cardType].twClass
        },
        getSvgPath() {
            return this.classAndPath[this.cardType].svgPath
        },
        getClipRule() {
            return this.classAndPath[this.cardType].clipRule
        },
        getFillRule() {
            return this.classAndPath[this.cardType].clipRule
        },

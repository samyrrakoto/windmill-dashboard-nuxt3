<template>
	...
	<div x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0"
		...
		<div x-transition:enter="transition ease-out duration-150"
			...
			x-transition:leave-end="opacity-0  transform translate-y-1/2" @keydown.escape="emitClosedModal()"
			...
			<header class="flex justify-end">
				<button
					...
					aria-label="close" @click="emitClosedModal()">
			...
			<footer class="flex flex-col items-center justify-end px-6 py-3 -mx-6 -mb-4 space-y-4 sm:space-y-0 sm:space-x-6 sm:flex-row bg-gray-50 dark:bg-gray-800">
				<button @click="emitClosedModal()" v-if="cancel"
